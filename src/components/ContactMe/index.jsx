...
import ContactForm from "../ContactMeForm/index.jsx";
          ...
          <div className="md:w-1/2 ">
            ...
            <div className="">
              ...
              <div className="grid md:flex flex-col space-x-4 ">
                ...
                <br />
                <a href="mailto:chamodgunarathna17@gmail.com">
                  <div className="flex hover:scale-110">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="25"
                    ...
                    &nbsp;&nbsp;&nbsp;chamodgunarathna17@gmail.com
                  </div>
                </a>
                <br />

                <a
                  href="https://github.com/chamodgunarathne"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="flex hover:scale-110">
                ...
                <br />
                <a
                  href="https://www.linkedin.com/in/chamod-gunarathna-95072b212/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="flex hover:scale-110">
                ...
                <br />
                <a
                  href="https://www.facebook.com/dilpa.gunarathna?mibextid=ZbWKwL"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="flex hover:scale-110">
                ...
                <br />
                <a
                  href="https://www.google.com/maps?q=Monaragala"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="flex hover:scale-110">
