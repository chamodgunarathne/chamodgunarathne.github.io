...
const Index = () => {
    ...
    return ( 
       ...
       <div className="p-8 md:flex text-xl tracking-wider justify-center">
       Reveal the core of my identity and explore the driving forces behind my journey.
       </div>
       <div className="grid md:flex bg-slate-200 rounded-lg m-10 p-4 shadow-xl">
  {/* First Column (25% width) */}
  <div className="md:w-1/4 border-8 border-slate-400 rounded-2xl m-8">
    <img src={Profile} alt="Profile" className="border-8 rounded-xl "/>
  </div>

  {/* Second Column (75% width) */}
  <div className="md:w-3/4 pl-4 bg-slate-100 rounded-2xl p-10 m-4 shadow-2xl leading-7 tracking-wider">
...
<div className="grid md:flex bg-slate-200 rounded-lg m-10 p-8 shadow-xl items-center tracking-wider">
Interested In &nbsp;  :  &nbsp;&nbsp; <div className="bg-blue-400 p-2 rounded-xl font-medium shadow-xl">
  ...
  <div className="grid md:flex bg-slate-200 rounded-lg m-10 p-8 shadow-xl items-center tracking-wider">
<div className="md:w-3/4 pl-4 bg-slate-100 rounded-2xl p-10 m-4 shadow-2xl leading-7 tracking-wider pl-10">
